...
/**
 * Helper class for Arrays and Collections: build HashMap from two arrays, build an ArrayList from
 * one or two Arrays
 * 
 * @author stivlo
 * 
...
public class ArrayHelper {
     ...
     * 
     * @param param
     *            HashMap with values to be used to populate our ArrayList
    ...
    /**
     * Builds an ArrayList from an array of int.
     * 
     * @param param
     *            an array of int
    ...
    /**
     * Builds an ArrayList from two HashMap. First all elements from param1 are added, after all
     * elements from param2.
     * 
     * @param param1
     *            HashMap with values to be used to populate our ArrayList
     * @param param2
    ...
    /**
     * Build an HashMap from two arrays, the first one is an array with keys, the second one with
     * values. The two arrays must have the same size. No check is done for now.
     * 
     * @param key
     * @param val
     * @return an HashMap
