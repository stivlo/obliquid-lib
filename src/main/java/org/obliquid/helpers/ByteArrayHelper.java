...
/**
 * Analyse and manipulate byte arrays: search, replace, toArray.
 * 
 * @author stivlo
 */
public final class ByteArrayHelper {
         ...
         * @param search
         *                the byte sequence to be found
         * @return false if the 'search' byte sequence is not contained in
         *         rawData, true if one or more byte sequences is found
         */
        ...
        /**
         * Replace all occourences of 'search' byte sequences with 'replace'
         * byte sequence in rawData.
         * 
         * @param rawData
         *                the input array
         * @param search
         ...
         * @return a new byte array with all 'search' byte sequences replaced by
         *         'replace' byte sequence
         */
        public static byte[] replace(final byte[] rawData, final byte[] search, final byte[] replace) {
         ...
         */
        public static byte[] toArray(final List<Byte> original) {
