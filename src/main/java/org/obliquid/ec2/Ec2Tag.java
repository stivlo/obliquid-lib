...
public class Ec2Tag {
     ...
     * @param tags
     *            the tag Collection
     * @return the value associated with the Tag or null if the "Name" tag wasn't found.
     */
    public static String getValueOfNameTag(Collection<Tag> tags) {
        for (Tag tag : tags) {
     ...
     */
    public static Collection<Tag> buildNameTagCollection(String value) {
